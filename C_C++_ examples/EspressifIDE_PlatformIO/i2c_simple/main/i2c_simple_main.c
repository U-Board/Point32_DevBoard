...
#define WRITE_REG_ADDR         0x6B        /*!< Register addresses of the power managment register */
#define RESET_BIT                   7
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(sensor_register_read(WHO_AM_I_REG_ADDR, data, 1));
    ESP_LOGI(TAG, "WHO_AM_I = %X", data[0]);

    /* Demonstrate writing by reseting the MPU9250 */
    ESP_ERROR_CHECK(sensor_register_write_byte(WRITE_REG_ADDR, 1 << RESET_BIT));
